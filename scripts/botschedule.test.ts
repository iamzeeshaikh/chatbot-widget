...
const cases: Case[] = [
  ...
  { label: 'Mon 16:00 PKT (Mon 11:00 UTC) packaging → ON', utc: '2026-06-22T11:00:00', site: PACK, expectOff: false },
  { label: 'Mon 18:59 PKT (Mon 13:59 UTC) packaging → ON', utc: '2026-06-22T13:59:00', site: PACK, expectOff: false },
  { label: 'Mon 19:00 PKT (Mon 14:00 UTC) packaging → OFF', utc: '2026-06-22T14:00:00', site: PACK, expectOff: true },
  ...
  // ── Weekday window: Tue–Fri 06:00–19:00 PKT is ON, the rest of the day OFF ──
  { label: 'Tue 05:59 PKT (Tue 00:59 UTC) packaging → OFF', utc: '2026-06-16T00:59:00', site: PACK, expectOff: true },
  { label: 'Tue 06:00 PKT (Tue 01:00 UTC) packaging → ON', utc: '2026-06-16T01:00:00', site: PACK, expectOff: false },
  { label: 'Tue 11:00 PKT (Tue 06:00 UTC) packaging → ON', utc: '2026-06-16T06:00:00', site: PACK, expectOff: false },
  { label: 'Tue 18:59 PKT (Tue 13:59 UTC) packaging → ON', utc: '2026-06-16T13:59:00', site: PACK, expectOff: false },
  { label: 'Tue 19:00 PKT (Tue 14:00 UTC) packaging → OFF', utc: '2026-06-16T14:00:00', site: PACK, expectOff: true },
  { label: 'Tue 21:00 PKT (Tue 16:00 UTC) packaging → OFF', utc: '2026-06-16T16:00:00', site: PACK, expectOff: true },
  { label: 'Wed 14:00 PKT (Wed 09:00 UTC) packaging → ON', utc: '2026-06-17T09:00:00', site: PACK, expectOff: false },
  { label: 'Wed 09:00 PKT (Wed 04:00 UTC) packaging → ON', utc: '2026-06-17T04:00:00', site: PACK, expectOff: false },
  { label: 'Wed 05:00 PKT (Wed 00:00 UTC) packaging → OFF', utc: '2026-06-17T00:00:00', site: PACK, expectOff: true },
  { label: 'Thu 12:30 PKT (Thu 07:30 UTC) packaging → ON', utc: '2026-06-18T07:30:00', site: PACK, expectOff: false },
  { label: 'Fri 18:00 PKT (Fri 13:00 UTC) packaging → ON', utc: '2026-06-19T13:00:00', site: PACK, expectOff: false },
  { label: 'Fri 19:00 PKT (Fri 14:00 UTC) packaging → OFF', utc: '2026-06-19T14:00:00', site: PACK, expectOff: true },
  ...
  // Monday stays out of the weekday window: 19:00 hands over to the human shift.
  { label: 'Mon 19:30 PKT (Mon 14:30 UTC) packaging → OFF', utc: '2026-06-22T14:30:00', site: PACK, expectOff: true },
...
onAssert(1, 18, true)  // Mon 18:00 on (window tail)
onAssert(1, 19, false) // Mon 19:00 off (end hour is exclusive)
onAssert(1, 23, false) // Mon night off
onAssert(1, 19, false) // Mon 19:00 off — Monday is not in the weekday window
onAssert(2, 5, false)  // Tue 05:00 off (before the weekday window)
onAssert(2, 6, true)   // Tue 06:00 on (first ON hour)
onAssert(3, 18, true)  // Wed 18:00 on (last ON hour)
onAssert(3, 19, false) // Wed 19:00 off (end hour is exclusive)
