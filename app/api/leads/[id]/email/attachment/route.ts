...
export async function POST(req: NextRequest, ctx: { params: Promise<{ id: string }> }) {
  ...
  // The contact-privacy gate that used to sit here is gone — the owner's
  // explicit decision, 2026-09-03: agents may fetch a customer's files even
  // where they may not read the customer's address, accepting that a document
  // can carry that address as pixels.
