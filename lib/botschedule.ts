...
//   • Weekday window: Tuesday–Friday, 11:00 AM to 4:00 PM PKT (16:00 exclusive,
//              so the last bot-ON minute is 15:59). These are the hours with no
//              human agent on shift; the rest of the weekday is human-only.
//   • Bot OFF (human-only): everything else — Monday from 4:00 PM, Tue–Fri
//              outside 11:00–16:00, and Saturday 00:00–10:00.
//
...
export const WEEKDAY_BOT_END_HOUR = 16 // 4:00 PM PKT (EXCLUSIVE — last ON minute is 15:59)
// ─────────────────────────────────────────────────────────────────────────────
