...
export const PACKAGING_SITES = ['shopcardboardboxes', 'thetubepackaging', 'kraftboxpack', 'thecandlepackaging']
...
export const LEAD_TRACKED_SITES = ['shopcardboardboxes', 'thetubepackaging', 'kraftboxpack', 'thecandlepackaging']
